...
public class CreateBill extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/7-32.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/exit.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/print.png"))); // NOI18N
 ...
 public void billno()
 {
   ...
   String query="INSERT INTO `bill`(bno,`cname`,amt,`pdate`) VALUES("+jTextField1.getText()+",'"+jTextField2.getText()+"',"+jTextField7.getText()+",'"+jTextField8.getText()+"');";
       ...
       Statement st;
       try{
            con = con=DriverManager.getConnection("jdbc:mysql://localhost:3306/supershop_management?serverTimezone=UTC", "root", "");
